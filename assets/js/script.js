...
$(document).ready(function () {
    ...
    let tourpack = new Swiper(".tour-pack-slider-active", {
        slidesPerView: 1,
        spaceBetween: 30,
        loop: true,
        pagination: {
            el: ".recent-deals-swiper-pagination3",
            clickable: true,
        },
        navigation: {
            nextEl: ".tour-pack-next",
            prevEl: ".tour-pack-prev",
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
...
tl.to(".slide-1", { opacity: 0, display: "none" }).to("#introduction", { opacity: 0, display: "none" });
